...
function Nodes(_ref) {
  ...
  return _react.default.createElement(_react.default.Fragment, null, nodes.map(function (node, i) {
    return _react.default.createElement(_group.Group, {
      key: "network-node-" + i,
      className: (0, _classnames.default)('vx-network-node', className),
      left: x(node),
      top: y(node)
...
Nodes.propTypes = {
  nodes: _propTypes.default.arrayOf(_propTypes.default.any),
  nodeComponent: _propTypes.default.oneOfType([_propTypes.default.string, _propTypes.default.any, _propTypes.default.elementType]).isRequired,
